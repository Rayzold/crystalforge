import { STEP_DURATIONS } from "../content/Config.js?v=v1.7.20-20260615092143";
import { formatDate, getStructuredDate } from "./CalendarSystem.js?v=v1.7.20-20260615092143";
import { recalculateCityStats } from "./CityStatsSystem.js?v=v1.7.20-20260615092143";
import { advanceConstructionOneDay } from "./ConstructionSystem.js?v=v1.7.20-20260615092143";
import { expireEvents, maybeTriggerHolidayEvents, maybeTriggerRandomEvents, processScheduledEvents } from "./EventSystem.js?v=v1.7.20-20260615092143";
import { advanceExpeditionsOneDay } from "./ExpeditionSystem.js?v=v1.7.20-20260615092143";
import { addHistoryEntry } from "./HistoryLogSystem.js?v=v1.7.20-20260615092143";
import { addMonthlyChronicleIfNeeded } from "./MonthlyChronicleSystem.js?v=v1.7.20-20260615092143";
import { applyDailyResources } from "./ResourceSystem.js?v=v1.7.20-20260615092143";
import { captureDailyCitySnapshot } from "./CitySnapshotSystem.js?v=v1.7.20-20260615092143";
import { applyTownFocusDailyEffects, updateTownFocusAvailability } from "./TownFocusSystem.js?v=v1.7.20-20260615092143";
import { getNewlyCompletedCraftingItems } from "./CraftingSystem.js?v=v1.7.20-20260615092143";
import { rollPercentCooldownsForDay } from "./CooldownSystem.js?v=v1.7.20-20260615092143";
import { ensureNextMonthWeatherGenerated } from "./WeatherSystem.js?v=v1.7.20-20260615092143";
