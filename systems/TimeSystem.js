import { STEP_DURATIONS } from "../content/Config.js?v=2.0.44-20260615090902";
import { formatDate, getStructuredDate } from "./CalendarSystem.js?v=2.0.44-20260615090902";
import { recalculateCityStats } from "./CityStatsSystem.js?v=2.0.44-20260615090902";
import { advanceConstructionOneDay } from "./ConstructionSystem.js?v=2.0.44-20260615090902";
import { expireEvents, maybeTriggerHolidayEvents, maybeTriggerRandomEvents, processScheduledEvents } from "./EventSystem.js?v=2.0.44-20260615090902";
import { advanceExpeditionsOneDay } from "./ExpeditionSystem.js?v=2.0.44-20260615090902";
import { addHistoryEntry } from "./HistoryLogSystem.js?v=2.0.44-20260615090902";
import { addMonthlyChronicleIfNeeded } from "./MonthlyChronicleSystem.js?v=2.0.44-20260615090902";
import { applyDailyResources } from "./ResourceSystem.js?v=2.0.44-20260615090902";
import { captureDailyCitySnapshot } from "./CitySnapshotSystem.js?v=2.0.44-20260615090902";
import { applyTownFocusDailyEffects, updateTownFocusAvailability } from "./TownFocusSystem.js?v=2.0.44-20260615090902";
import { getNewlyCompletedCraftingItems } from "./CraftingSystem.js?v=2.0.44-20260615090902";
import { rollPercentCooldownsForDay } from "./CooldownSystem.js?v=2.0.44-20260615090902";
import { ensureNextMonthWeatherGenerated } from "./WeatherSystem.js?v=2.0.44-20260615090902";
