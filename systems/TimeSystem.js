import { STEP_DURATIONS } from "../content/Config.js?v=v1.7.21-20260628204921";
import { formatDate, getStructuredDate } from "./CalendarSystem.js?v=v1.7.21-20260628204921";
import { recalculateCityStats } from "./CityStatsSystem.js?v=v1.7.21-20260628204921";
import { advanceConstructionOneDay } from "./ConstructionSystem.js?v=v1.7.21-20260628204921";
import { expireEvents, maybeTriggerHolidayEvents, maybeTriggerRandomEvents, processScheduledEvents } from "./EventSystem.js?v=v1.7.21-20260628204921";
import { advanceExpeditionsOneDay } from "./ExpeditionSystem.js?v=v1.7.21-20260628204921";
import { addHistoryEntry } from "./HistoryLogSystem.js?v=v1.7.21-20260628204921";
import { addMonthlyChronicleIfNeeded } from "./MonthlyChronicleSystem.js?v=v1.7.21-20260628204921";
import { applyDailyResources } from "./ResourceSystem.js?v=v1.7.21-20260628204921";
import { captureDailyCitySnapshot } from "./CitySnapshotSystem.js?v=v1.7.21-20260628204921";
import { applyTownFocusDailyEffects, updateTownFocusAvailability } from "./TownFocusSystem.js?v=v1.7.21-20260628204921";
import { getNewlyCompletedCraftingItems } from "./CraftingSystem.js?v=v1.7.21-20260628204921";
import { rollPercentCooldownsForDay } from "./CooldownSystem.js?v=v1.7.21-20260628204921";
import { ensureNextMonthWeatherGenerated } from "./WeatherSystem.js?v=v1.7.21-20260628204921";
