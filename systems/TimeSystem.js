import { STEP_DURATIONS } from "../content/Config.js?v=v1.7.21-20260628063649";
import { formatDate, getStructuredDate } from "./CalendarSystem.js?v=v1.7.21-20260628063649";
import { recalculateCityStats } from "./CityStatsSystem.js?v=v1.7.21-20260628063649";
import { advanceConstructionOneDay } from "./ConstructionSystem.js?v=v1.7.21-20260628063649";
import { expireEvents, maybeTriggerHolidayEvents, maybeTriggerRandomEvents, processScheduledEvents } from "./EventSystem.js?v=v1.7.21-20260628063649";
import { advanceExpeditionsOneDay } from "./ExpeditionSystem.js?v=v1.7.21-20260628063649";
import { addHistoryEntry } from "./HistoryLogSystem.js?v=v1.7.21-20260628063649";
import { addMonthlyChronicleIfNeeded } from "./MonthlyChronicleSystem.js?v=v1.7.21-20260628063649";
import { applyDailyResources } from "./ResourceSystem.js?v=v1.7.21-20260628063649";
import { captureDailyCitySnapshot } from "./CitySnapshotSystem.js?v=v1.7.21-20260628063649";
import { applyTownFocusDailyEffects, updateTownFocusAvailability } from "./TownFocusSystem.js?v=v1.7.21-20260628063649";
import { getNewlyCompletedCraftingItems } from "./CraftingSystem.js?v=v1.7.21-20260628063649";
import { rollPercentCooldownsForDay } from "./CooldownSystem.js?v=v1.7.21-20260628063649";
import { ensureNextMonthWeatherGenerated } from "./WeatherSystem.js?v=v1.7.21-20260628063649";
