import { STEP_DURATIONS } from "../content/Config.js?v=v1.7.20-20260623075447";
import { formatDate, getStructuredDate } from "./CalendarSystem.js?v=v1.7.20-20260623075447";
import { recalculateCityStats } from "./CityStatsSystem.js?v=v1.7.20-20260623075447";
import { advanceConstructionOneDay } from "./ConstructionSystem.js?v=v1.7.20-20260623075447";
import { expireEvents, maybeTriggerHolidayEvents, maybeTriggerRandomEvents, processScheduledEvents } from "./EventSystem.js?v=v1.7.20-20260623075447";
import { advanceExpeditionsOneDay } from "./ExpeditionSystem.js?v=v1.7.20-20260623075447";
import { addHistoryEntry } from "./HistoryLogSystem.js?v=v1.7.20-20260623075447";
import { addMonthlyChronicleIfNeeded } from "./MonthlyChronicleSystem.js?v=v1.7.20-20260623075447";
import { applyDailyResources } from "./ResourceSystem.js?v=v1.7.20-20260623075447";
import { captureDailyCitySnapshot } from "./CitySnapshotSystem.js?v=v1.7.20-20260623075447";
import { applyTownFocusDailyEffects, updateTownFocusAvailability } from "./TownFocusSystem.js?v=v1.7.20-20260623075447";
import { getNewlyCompletedCraftingItems } from "./CraftingSystem.js?v=v1.7.20-20260623075447";
import { rollPercentCooldownsForDay } from "./CooldownSystem.js?v=v1.7.20-20260623075447";
import { ensureNextMonthWeatherGenerated } from "./WeatherSystem.js?v=v1.7.20-20260623075447";
