...
import { sumObjectValues } from "../engine/Utils.js?v=v1.7.21-20260628063649";
import { getDistrictSummary } from "./DistrictSystem.js?v=v1.7.21-20260628063649";
import { scalePopulationSupport } from "./DriftEvolutionSystem.js?v=v1.7.21-20260628063649";
import { getUniqueCitizenStatBonuses } from "./ExpeditionSystem.js?v=v1.7.21-20260628063649";
import { iterateCitizenRarityEntries } from "./CitizenSystem.js?v=v1.7.21-20260628063649";
import { getBuildingPlacementBonuses } from "./MapSystem.js?v=v1.7.21-20260628063649";
import { getCurrentTownFocus } from "./TownFocusSystem.js?v=v1.7.21-20260628063649";
import { getGoodsOutputMultiplier, getHousingStrainPenalty } from "./CityConditionSystem.js?v=v1.7.21-20260628063649";
import {
  applyBuildingWorkforceToStat,
  getBuildingWorkforceMultiplier,
  getWorkforceSummary
} from "./WorkforceSystem.js?v=v1.7.21-20260628063649";
