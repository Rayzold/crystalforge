...
import { sumObjectValues } from "../engine/Utils.js?v=v1.7.20-20260615093534";
import { getDistrictSummary } from "./DistrictSystem.js?v=v1.7.20-20260615093534";
import { scalePopulationSupport } from "./DriftEvolutionSystem.js?v=v1.7.20-20260615093534";
import { getUniqueCitizenStatBonuses } from "./ExpeditionSystem.js?v=v1.7.20-20260615093534";
import { iterateCitizenRarityEntries } from "./CitizenSystem.js?v=v1.7.20-20260615093534";
import { getBuildingPlacementBonuses } from "./MapSystem.js?v=v1.7.20-20260615093534";
import { getCurrentTownFocus } from "./TownFocusSystem.js?v=v1.7.20-20260615093534";
import { getGoodsOutputMultiplier, getHousingStrainPenalty } from "./CityConditionSystem.js?v=v1.7.20-20260615093534";
import {
  applyBuildingWorkforceToStat,
  getBuildingWorkforceMultiplier,
  getWorkforceSummary
} from "./WorkforceSystem.js?v=v1.7.20-20260615093534";
