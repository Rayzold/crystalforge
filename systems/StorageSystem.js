...
import { BASE_BUILDING_CATALOG, buildFlavorText } from "../content/BuildingCatalog.js?v=v1.7.21-20260817120405";
import { getNextRarity } from "../content/Rarities.js?v=v1.7.21-20260817120405";
import { createId, safeJsonParse } from "../engine/Utils.js?v=v1.7.21-20260817120405";
import { formatDate } from "./CalendarSystem.js?v=v1.7.21-20260817120405";
import {
...
} from "./CitizenSystem.js?v=v1.7.21-20260817120405";
import { normalizeCrystalCollection } from "./CrystalSystem.js?v=v1.7.21-20260817120405";
import { recalculateCityStats } from "./CityStatsSystem.js?v=v1.7.21-20260817120405";
import { getDistrictSummary } from "./DistrictSystem.js?v=v1.7.21-20260817120405";
import { normalizeShardCollection } from "./ShardSystem.js?v=v1.7.21-20260817120405";
import { createMapCells } from "./MapSystem.js?v=v1.7.21-20260817120405";
import { createDefaultDriftEvolutionState, normalizeDriftEvolutionState, syncDriftEvolutionState } from "./DriftEvolutionSystem.js?v=v1.7.21-20260817120405";
import { getDriftConstructionSlots, normalizeConstructionPriority } from "./ConstructionSystem.js?v=v1.7.21-20260817120405";
import { createDefaultTownFocusState, normalizeTownFocusState } from "./TownFocusSystem.js?v=v1.7.21-20260817120405";
import { captureDailyCitySnapshot } from "./CitySnapshotSystem.js?v=v1.7.21-20260817120405";
import {
  createDefaultExpeditionState,
  normalizeExpeditionState,
  normalizeUniqueCitizens,
  normalizeVehicleFleet
} from "./ExpeditionSystem.js?v=v1.7.21-20260817120405";
import { createDefaultVehicleFleet } from "../content/VehicleConfig.js?v=v1.7.21-20260817120405";
import { normalizeBehemoths } from "./BehemothSystem.js?v=v1.7.21-20260817120405";
import { normalizeNpcs } from "./NpcSystem.js?v=v1.7.21-20260817120405";
import { normalizeAwakenedRoster } from "./AwakenedSystem.js?v=v1.7.21-20260817120405";
import { normalizeCraftingItems } from "./CraftingSystem.js?v=v1.7.21-20260817120405";
import { normalizeCooldowns } from "./CooldownSystem.js?v=v1.7.21-20260817120405";
  ...
  return Object.fromEntries(
    Object.entries(baseCatalog).map(([key, baseEntry]) => {
      ...
      const entry = {
        ...
        // Shipped apex notes are authoritative: if the base catalog defines one
        // it wins, so updated/added notes reach existing saves. Buildings that
        // ship without a note keep any GM-authored custom note from the save.
        apexNote:
          (typeof baseEntry.apexNote === "string" && baseEntry.apexNote.trim())
            ? baseEntry.apexNote
            : (sourceEntry.apexNote ?? baseEntry.apexNote ?? "")
      };
  ...
  return buildings.map((building) => ({
    ...
    imageData:
      typeof building.imageData === "string" && building.imageData.startsWith("data:image/")
        ? building.imageData
        : "",
    // Instances bake apexNote at manifest time; re-sync from the resolved
    // catalog so shipped note changes show on already-owned buildings.
    apexNote: catalog?.[building.key]?.apexNote ?? building.apexNote ?? "",
