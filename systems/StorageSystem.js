...
import { BASE_BUILDING_CATALOG, buildFlavorText } from "../content/BuildingCatalog.js?v=v1.7.21-20260628030617";
import { getNextRarity } from "../content/Rarities.js?v=v1.7.21-20260628030617";
import { createId, safeJsonParse } from "../engine/Utils.js?v=v1.7.21-20260628030617";
...
} from "./CitizenSystem.js?v=v1.7.21-20260628030617";
import { normalizeCrystalCollection } from "./CrystalSystem.js?v=v1.7.21-20260628030617";
import { recalculateCityStats } from "./CityStatsSystem.js?v=v1.7.21-20260628030617";
import { getDistrictSummary } from "./DistrictSystem.js?v=v1.7.21-20260628030617";
import { normalizeShardCollection } from "./ShardSystem.js?v=v1.7.21-20260628030617";
import { createMapCells } from "./MapSystem.js?v=v1.7.21-20260628030617";
import { createDefaultDriftEvolutionState, normalizeDriftEvolutionState, syncDriftEvolutionState } from "./DriftEvolutionSystem.js?v=v1.7.21-20260628030617";
import { getDriftConstructionSlots, normalizeConstructionPriority } from "./ConstructionSystem.js?v=v1.7.21-20260628030617";
import { createDefaultTownFocusState, normalizeTownFocusState } from "./TownFocusSystem.js?v=v1.7.21-20260628030617";
import { captureDailyCitySnapshot } from "./CitySnapshotSystem.js?v=v1.7.21-20260628030617";
import {
...
import { createDefaultVehicleFleet } from "../content/VehicleConfig.js?v=v1.7.21-20260628030617";
import { normalizeBehemoths } from "./BehemothSystem.js?v=v1.7.21-20260628030617";
import { normalizeNpcs } from "./NpcSystem.js?v=v1.7.21-20260628030617";
import { normalizeAwakenedRoster } from "./AwakenedSystem.js?v=v1.7.21-20260628030617";
import { normalizeCraftingItems } from "./CraftingSystem.js?v=v1.7.21-20260628030617";
import { normalizeCooldowns } from "./CooldownSystem.js?v=v1.7.21-20260628030617";
