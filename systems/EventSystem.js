...
import { EVENT_STEP_CHANCES, MAX_RECENT_EVENTS } from "../content/Config.js?v=v1.7.20-20260621155633";
import { pickRandom, randomInt } from "../engine/Random.js?v=v1.7.20-20260621155633";
import { addHistoryEntry } from "./HistoryLogSystem.js?v=v1.7.20-20260621155633";
import { formatDate, getHolidayName } from "./CalendarSystem.js?v=v1.7.20-20260621155633";
import { getDistrictSummary } from "./DistrictSystem.js?v=v1.7.20-20260621155633";
import { getWarningFlags } from "./ResourceSystem.js?v=v1.7.20-20260621155633";
import { getEventRollModifier, getEventTypeWeight } from "./CityConditionSystem.js?v=v1.7.20-20260621155633";
