...
import { EVENT_STEP_CHANCES, MAX_RECENT_EVENTS } from "../content/Config.js?v=v1.7.20-20260623073844";
import { pickRandom, randomInt } from "../engine/Random.js?v=v1.7.20-20260623073844";
import { addHistoryEntry } from "./HistoryLogSystem.js?v=v1.7.20-20260623073844";
import { formatDate, getHolidayName } from "./CalendarSystem.js?v=v1.7.20-20260623073844";
import { getDistrictSummary } from "./DistrictSystem.js?v=v1.7.20-20260623073844";
import { getWarningFlags } from "./ResourceSystem.js?v=v1.7.20-20260623073844";
import { getEventRollModifier, getEventTypeWeight } from "./CityConditionSystem.js?v=v1.7.20-20260623073844";
