...
} from "../content/CitizenConfig.js?v=v1.7.22-20260904120000";
import { DEFAULT_EFFORT_LEVEL, DEFAULT_SALARIES_LEVEL, RESOURCE_MINIMUMS } from "../content/Config.js?v=v1.7.22-20260904120000";
import { clamp } from "../engine/Utils.js?v=v1.7.22-20260904120000";
import { getDistrictSummary } from "./DistrictSystem.js?v=v1.7.22-20260904120000";
import { getBuildingTierResourceRate } from "./BuildingSystem.js?v=v1.7.22-20260904120000";
import {
...
import { getBuildingPlacementBonuses } from "./MapSystem.js?v=v1.7.22-20260904120000";
import { getCurrentTownFocus, getSuggestedFocusForAlert } from "./TownFocusSystem.js?v=v1.7.22-20260904120000";
import { iterateCitizenRarityEntries } from "./CitizenSystem.js?v=v1.7.22-20260904120000";
import {
  applyBuildingWorkforceToResource,
  getBuildingWorkforceMultiplier,
  getWorkforceSummary
} from "./WorkforceSystem.js?v=v1.7.22-20260904120000";
import {
  getEventRollModifier,
  getFoodOutputMultiplier,
  getGoldOutputMultiplier
} from "./CityConditionSystem.js?v=v1.7.22-20260904120000";
