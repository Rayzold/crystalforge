...
import { renderChroniclePage } from "./ChroniclePage.js?v=2.0.28";
...
import { renderCityPage, renderEconomyPage } from "./CityPage.js?v=2.0.28";
import { renderExpeditionsPage } from "./ExpeditionsPage.js?v=2.0.28";
...
import { renderTurnSummaryModal } from "./TurnSummaryModal.js?v=2.0.28";
import { renderUniqueCitizensPage } from "./UniqueCitizensPage.js";
import { renderEquipmentSheetPage } from "./EquipmentSheetPage.js?v=2.0.28";
import { renderVehiclesPage } from "./VehiclesPage.js";
import { renderBehemothsPage } from "./BehemothsPage.js";
import { renderNpcsPage } from "./NpcsPage.js?v=2.0.28";
import { renderAwakenedPage } from "./AwakenedPage.js";
import { renderArmyPage } from "./ArmyPage.js";
import { renderCraftingPage } from "./CraftingPage.js?v=2.0.28";
import { renderCooldownsPage } from "./CooldownsPage.js?v=2.0.28";
import { isCooldownReady } from "../systems/CooldownSystem.js?v=2.0.28";
