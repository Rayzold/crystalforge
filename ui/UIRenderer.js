...
import { renderCityPage, renderEconomyPage } from "./CityPage.js?v=2.0.18";
...
import { renderTurnSummaryModal } from "./TurnSummaryModal.js?v=2.0.18";
...
import { renderNpcsPage } from "./NpcsPage.js?v=2.0.18";
import { renderAwakenedPage } from "./AwakenedPage.js";
import { renderArmyPage } from "./ArmyPage.js";
import { renderCraftingPage } from "./CraftingPage.js?v=2.0.18";
import { renderCooldownsPage } from "./CooldownsPage.js?v=2.0.18";
import { isCooldownReady } from "../systems/CooldownSystem.js?v=2.0.18";
