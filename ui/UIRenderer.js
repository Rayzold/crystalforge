...
import { renderChroniclePage } from "./ChroniclePage.js?v=2.0.27";
...
import { renderCityPage, renderEconomyPage } from "./CityPage.js?v=2.0.27";
import { renderExpeditionsPage } from "./ExpeditionsPage.js?v=2.0.27";
...
import { renderTurnSummaryModal } from "./TurnSummaryModal.js?v=2.0.27";
import { renderUniqueCitizensPage } from "./UniqueCitizensPage.js";
import { renderEquipmentSheetPage } from "./EquipmentSheetPage.js?v=2.0.27";
import { renderVehiclesPage } from "./VehiclesPage.js";
import { renderBehemothsPage } from "./BehemothsPage.js";
import { renderNpcsPage } from "./NpcsPage.js?v=2.0.27";
import { renderAwakenedPage } from "./AwakenedPage.js";
import { renderArmyPage } from "./ArmyPage.js";
import { renderCraftingPage } from "./CraftingPage.js?v=2.0.27";
import { renderCooldownsPage } from "./CooldownsPage.js?v=2.0.27";
import { isCooldownReady } from "../systems/CooldownSystem.js?v=2.0.27";
