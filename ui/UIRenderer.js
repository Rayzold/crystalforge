...
import { renderCityPage, renderEconomyPage } from "./CityPage.js?v=2.0.10";
...
import { renderTurnSummaryModal } from "./TurnSummaryModal.js?v=2.0.10";
...
import { renderNpcsPage } from "./NpcsPage.js?v=2.0.10";
import { renderAwakenedPage } from "./AwakenedPage.js";
import { renderArmyPage } from "./ArmyPage.js";
import { renderCraftingPage } from "./CraftingPage.js?v=2.0.10";
import { renderCooldownsPage } from "./CooldownsPage.js?v=2.0.10";
import { isCooldownReady } from "../systems/CooldownSystem.js?v=2.0.10";
