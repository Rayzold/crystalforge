        ...
        <div class="turn-summary-modal__body">
          ...
          <section class="turn-summary-modal__section">
            ...
            <div class="turn-summary-modal__facts">
              ...
              <article>
                <span>Journey Debriefs</span>
                <strong>${formatNumber(summary.expeditionJourneys?.length ?? 0, 0)}</strong>
                <small>${escapeHtml(summary.expeditionJourneys?.length ? summary.expeditionJourneys.join(", ") : "No expedition debriefs opened this turn.")}</small>
              </article>
            </div>
          </section>
        </div>
