...
import { CITIZEN_DEFINITIONS, CITIZEN_GROUP_ORDER } from "../content/CitizenConfig.js?v=2.0.44-20260615090902";
import {
  AWAKENED_GRADES,
  getAwakenedAbilityTypeLabel,
  getAwakenedStatusLabel
} from "../content/AwakenedConfig.js?v=2.0.44-20260615090902";
import { VEHICLE_DEFINITIONS, VEHICLE_ORDER } from "../content/VehicleConfig.js?v=2.0.44-20260615090902";
import { getBehemothStatusLabel } from "../content/BehemothConfig.js?v=2.0.44-20260615090902";
...
import { getAvailableVehicleCounts, getVehicleAssignments } from "../systems/ExpeditionSystem.js?v=2.0.44-20260615090902";
import { getBuildingMultiplier } from "../systems/BuildingSystem.js?v=2.0.44-20260615090902";
