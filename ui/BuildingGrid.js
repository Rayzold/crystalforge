import { BUILDING_GRID_LIMIT } from "../content/Config.js?v=v1.7.24-20260907120000";
import { getBuildingEconomySummary } from "../content/BuildingCatalog.js?v=v1.7.24-20260907120000";
import { RARITY_ORDER } from "../content/Rarities.js?v=v1.7.24-20260907120000";
import { sortBuildings } from "../engine/Utils.js?v=v1.7.24-20260907120000";
import { getActiveConstructionQueue, getConstructionEtaDetails, getDriftConstructionSlots, isBuildingActivelyConstructed } from "../systems/ConstructionSystem.js?v=v1.7.24-20260907120000";
import { getBuildingWorkforceStatus, getWorkforceSummary } from "../systems/WorkforceSystem.js?v=v1.7.24-20260907120000";
import { renderBuildingCard } from "./BuildingCard.js?v=v1.7.24-20260907120000";
