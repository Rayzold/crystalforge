...
import { dateFromParts, formatDate, getStructuredDate } from "../systems/CalendarSystem.js?v=v1.7.20-20260615092143";
import { MONTHS, DAYS_PER_MONTH } from "../content/CalendarConfig.js?v=v1.7.20-20260615092143";
import { getActiveCraftingUpkeep } from "../systems/CraftingSystem.js?v=v1.7.20-20260615092143";
import { getCrafterCapacity } from "../systems/NpcSystem.js?v=v1.7.20-20260615092143";
  ...
  return `
    <section class="panel crafting-form" id="crafting-form" data-crafter-level="${escapeHtml(v.crafterLevel ?? "")}" data-batch-count="1">
      ...
      <div class="crafting-form__grid">
        ...
        <div class="crafting-form__field crafting-form__field--full" data-crafting-batch-row>
          <label class="crafting-form__label">Batch Size <span style="font-weight:400;color:var(--muted);font-size:0.8em;">(produce many in less total time — works for any item)</span></label>
