...
import { APP_DISPLAY_VERSION, BUILD_NOTES, FIREBASE_DEFAULT_REALM_ID } from "../content/Config.js?v=v1.7.24-20260907120000";
import { BUILDING_ROLE_LEGEND, getBuildingEmoji } from "../content/BuildingCatalog.js?v=v1.7.24-20260907120000";
import { CITIZEN_CLASSES, CITIZEN_DEFINITIONS, CITIZEN_GROUP_ORDER, getCitizenHelpText } from "../content/CitizenConfig.js?v=v1.7.24-20260907120000";
import { GLOSSARY_TERMS } from "../content/GlossaryConfig.js?v=v1.7.24-20260907120000";
...
import { formatDate, getNextHoliday, getStructuredDate } from "../systems/CalendarSystem.js?v=v1.7.24-20260907120000";
import { formatBuildingExactQualityDisplay, getBuildingMultiplier } from "../systems/BuildingSystem.js?v=v1.7.24-20260907120000";
...
import { getTradeGoodsGoldMultiplier, getCityTrendSummary, getGoodsSummary, getResourceChainSummary } from "../systems/ResourceSystem.js?v=v1.7.24-20260907120000";
import { getFoodOutputMultiplier, getGoldOutputMultiplier } from "../systems/CityConditionSystem.js?v=v1.7.24-20260907120000";
import { getBuildingPlacementBonuses } from "../systems/MapSystem.js?v=v1.7.24-20260907120000";
import { getMayorAdvice } from "../systems/TownFocusSystem.js?v=v1.7.24-20260907120000";
import { applyBuildingWorkforceToResource, getBuildingWorkforceStatus, getBuildingWorkforceMultiplier, getWorkforceSummary } from "../systems/WorkforceSystem.js?v=v1.7.24-20260907120000";
import { renderCrystalSelector } from "./CrystalSelector.js?v=v1.7.24-20260907120000";
import { createHelpBubble } from "./HelpBubbles.js?v=v1.7.24-20260907120000";
import { getHolidayGlyph, getHolidayTypeClass } from "./HolidayPresentation.js?v=v1.7.24-20260907120000";
import { renderManifestPanel } from "./ManifestPanel.js?v=v1.7.24-20260907120000";
  ...
  return `
    <section class="panel player-session-banner">
      ...
      <div class="player-session-banner__grid">
        ...
        <article>
          <span>The Drift is above</span>
          <strong>${escapeHtml(state.settings?.driftRegion ?? "Adrift")}</strong>
        </article>
        <article>
          <span>Published</span>
