...
import { APP_DISPLAY_VERSION, BUILD_NOTES, FIREBASE_DEFAULT_REALM_ID } from "../content/Config.js?v=v1.7.21-20260629112345";
import { BUILDING_ROLE_LEGEND, getBuildingEmoji } from "../content/BuildingCatalog.js?v=v1.7.21-20260629112345";
import { CITIZEN_CLASSES, CITIZEN_DEFINITIONS, CITIZEN_GROUP_ORDER, getCitizenHelpText } from "../content/CitizenConfig.js?v=v1.7.21-20260629112345";
import { GLOSSARY_TERMS } from "../content/GlossaryConfig.js?v=v1.7.21-20260629112345";
...
import { formatDate, getNextHoliday, getStructuredDate } from "../systems/CalendarSystem.js?v=v1.7.21-20260629112345";
import { formatBuildingExactQualityDisplay, getBuildingMultiplier } from "../systems/BuildingSystem.js?v=v1.7.21-20260629112345";
import { getActiveConstructionQueue, getAvailableConstructionQueue, getConstructionEtaDetails } from "../systems/ConstructionSystem.js?v=v1.7.21-20260629112345";
import { getTradeGoodsGoldMultiplier, getCityTrendSummary, getGoodsSummary, getResourceChainSummary } from "../systems/ResourceSystem.js?v=v1.7.21-20260629112345";
import { getFoodOutputMultiplier, getGoldOutputMultiplier } from "../systems/CityConditionSystem.js?v=v1.7.21-20260629112345";
import { getBuildingPlacementBonuses } from "../systems/MapSystem.js?v=v1.7.21-20260629112345";
import { getMayorAdvice } from "../systems/TownFocusSystem.js?v=v1.7.21-20260629112345";
import { applyBuildingWorkforceToResource, getBuildingWorkforceStatus, getBuildingWorkforceMultiplier, getWorkforceSummary } from "../systems/WorkforceSystem.js?v=v1.7.21-20260629112345";
import { renderCrystalSelector } from "./CrystalSelector.js?v=v1.7.21-20260629112345";
import { createHelpBubble } from "./HelpBubbles.js?v=v1.7.21-20260629112345";
import { getHolidayGlyph, getHolidayTypeClass } from "./HolidayPresentation.js?v=v1.7.21-20260629112345";
import { renderManifestPanel } from "./ManifestPanel.js?v=v1.7.21-20260629112345";
