...
import { APP_DISPLAY_VERSION, BUILD_NOTES, FIREBASE_DEFAULT_REALM_ID } from "../content/Config.js?v=v1.7.21-20260627203913";
import { BUILDING_ROLE_LEGEND, getBuildingEmoji } from "../content/BuildingCatalog.js?v=v1.7.21-20260627203913";
...
import { GLOSSARY_TERMS } from "../content/GlossaryConfig.js?v=v1.7.21-20260627203913";
...
import { formatDate, getNextHoliday, getStructuredDate } from "../systems/CalendarSystem.js?v=v1.7.21-20260627203913";
import { formatBuildingExactQualityDisplay, getBuildingMultiplier } from "../systems/BuildingSystem.js?v=v1.7.21-20260627203913";
import { getActiveConstructionQueue, getAvailableConstructionQueue, getConstructionEtaDetails } from "../systems/ConstructionSystem.js?v=v1.7.21-20260627203913";
import { getTradeGoodsGoldMultiplier, getCityTrendSummary, getGoodsSummary, getResourceChainSummary } from "../systems/ResourceSystem.js?v=v1.7.21-20260627203913";
import { getFoodOutputMultiplier, getGoldOutputMultiplier } from "../systems/CityConditionSystem.js?v=v1.7.21-20260627203913";
import { getBuildingPlacementBonuses } from "../systems/MapSystem.js?v=v1.7.21-20260627203913";
import { getMayorAdvice } from "../systems/TownFocusSystem.js?v=v1.7.21-20260627203913";
import { applyBuildingWorkforceToResource, getBuildingWorkforceStatus, getBuildingWorkforceMultiplier, getWorkforceSummary } from "../systems/WorkforceSystem.js?v=v1.7.21-20260627203913";
import { renderCrystalSelector } from "./CrystalSelector.js?v=v1.7.21-20260627203913";
import { createHelpBubble } from "./HelpBubbles.js?v=v1.7.21-20260627203913";
import { getHolidayGlyph, getHolidayTypeClass } from "./HolidayPresentation.js?v=v1.7.21-20260627203913";
import { renderManifestPanel } from "./ManifestPanel.js?v=v1.7.21-20260627203913";
