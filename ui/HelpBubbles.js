...
const HELP_TEXT = {
  ...
  "Featured Structures": "Highlights notable active buildings so the table can quickly revisit important pieces of the city.",
  ...
  "Roll Table Review": "Summarizes how many buildings remain inactive in each rarity pool.",
  ...
  "Authored Building Catalog": "Displays the current rollable building catalog with filters, activation state, and current stage or quality.",
