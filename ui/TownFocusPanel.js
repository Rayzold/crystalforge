...
import { getCurrentTownFocus, getMayorSuggestions, getTownFocusAvailability } from "../systems/TownFocusSystem.js?v=v1.7.21-20260628204921";
import {
  calculateTownFocusPreview,
  renderTownFocusBadge,
  renderTownFocusEffectSummary,
  renderTownFocusProjectionStrip
} from "./TownFocusShared.js?v=v1.7.21-20260628204921";
    ...
    <section class="scene-panel town-focus-panel" id="town-focus-council">
      <div class="panel__header">
        ...
        <div class="town-focus-panel__header-actions">
          ...
          <button class="button button--ghost" data-action="toggle-town-focus-panel">
            ${expanded ? "Minimize Council" : "Expand Council"}
          </button>
        </div>
      </div>
      ...
      ${
        expanded
          ? `
            ...
            <div class="town-focus-panel__footer-actions">
