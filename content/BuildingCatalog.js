...
import { BUILDING_POOLS } from "./BuildingPools.js?v=v1.7.20-20260615092907";
import { RARITY_ORDER } from "./Rarities.js?v=v1.7.20-20260615092907";
...
const BUILDING_DEFINITIONS = {
  ...
  "Housing: Commoner": defineBuilding({ district: "Residential District", tags: ["housing"], iconKey: "home", flavorText: "Simple walls, shared routines, and dependable shelter make this the real shape of the city's ordinary life.", profile: gameplay({ upkeep: 3, populationSupport: 180 }) }),
  ...
  "Housing: Comfortable": defineBuilding({ district: "Residential District", tags: ["housing"], iconKey: "home", flavorText: "Better light, more room, and a little privacy make this feel like stability instead of mere shelter.", profile: gameplay({ upkeep: 6, populationSupport: 320 }) }),
