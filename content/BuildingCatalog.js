...
const BUILDING_DEFINITIONS = {
  ...
  "Inn": defineBuilding({ district: "Residential District", tags: ["housing", "trade"], iconKey: "home", profile: gameplay({ gold: 6, upkeep: 4, morale: 3, populationSupport: 50 }) }),
  ...
  Stables: defineBuilding({ district: "Military District", tags: ["military", "housing"], iconKey: "shield", profile: gameplay({ upkeep: 4, security: 4, goods: 1, populationSupport: 20 }) }),
