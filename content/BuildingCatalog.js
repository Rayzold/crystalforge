...
const BUILDING_DEFINITIONS = {
  "Apiary": defineBuilding({ district: "Agricultural District", tags: ["agriculture"], iconKey: "leaf", profile: gameplay({ upkeep: 1, food: 3, goods: 1, morale: 2 }) }),
  "Bakery": defineBuilding({ district: "Industrial District", tags: ["industry", "agriculture"], iconKey: "hammer", profile: gameplay({ upkeep: 2, food: 4, goods: 2, morale: 2 }) }),
  ...
  "Blacksmith": defineBuilding({ district: "Industrial District", tags: ["industry", "trade"], iconKey: "hammer", profile: gameplay({ upkeep: 3, prosperity: 2, goods: 3, materials: -1 }) }),
  "Butcher": defineBuilding({ district: "Agricultural District", tags: ["agriculture", "trade"], iconKey: "leaf", profile: gameplay({ upkeep: 2, food: 5, goods: 2 }) }),
  "Cider Press": defineBuilding({ district: "Agricultural District", tags: ["agriculture", "trade"], iconKey: "leaf", profile: gameplay({ upkeep: 1, food: 2, goods: 2, morale: 2 }) }),
  ...
  "Fishery": defineBuilding({ district: "Agricultural District", tags: ["agriculture", "harbor"], iconKey: "anchor", profile: gameplay({ upkeep: 2, food: 7 }) }),
  ...
  "Trade Center": defineBuilding({ district: "Trade District", tags: ["trade"], iconKey: "coins", profile: gameplay({ gold: 8, upkeep: 2, prosperity: 2 }) }),
  ...
  "Grain Silo": defineBuilding({ district: "Agricultural District", tags: ["agriculture", "security"], iconKey: "leaf", profile: gameplay({ upkeep: 1, security: 3, prosperity: 1 }) }),
  ...
  "Inn": defineBuilding({ district: "Residential District", tags: ["housing", "trade"], iconKey: "home", profile: gameplay({ gold: 8, upkeep: 4, morale: 3, populationSupport: 50 }) }),
  "Lumber Mill": defineBuilding({ district: "Industrial District", tags: ["industry"], iconKey: "hammer", profile: gameplay({ upkeep: 3, prosperity: 2, materials: 5, goods: 1 }) }),
  Mill: defineBuilding({ district: "Agricultural District", tags: ["agriculture", "industry"], iconKey: "hammer", profile: gameplay({ upkeep: 2, food: 6, goods: 2 }) }),
  Mine: defineBuilding({ district: "Industrial District", tags: ["industry"], iconKey: "hammer", profile: gameplay({ upkeep: 5, prosperity: 2, materials: 6 }) }),
  Quarry: defineBuilding({ district: "Industrial District", tags: ["industry"], iconKey: "hammer", profile: gameplay({ upkeep: 4, prosperity: 2, materials: 5 }) }),
  "Smokehouse": defineBuilding({ district: "Agricultural District", tags: ["agriculture", "industry"], iconKey: "hammer", profile: gameplay({ upkeep: 2, food: 4, goods: 2 }) }),
  Stables: defineBuilding({ district: "Military District", tags: ["military", "housing"], iconKey: "shield", profile: gameplay({ upkeep: 4, security: 4, prosperity: 2, goods: 1, populationSupport: 20 }) }),
  Tailor: defineBuilding({ district: "Trade District", tags: ["trade"], iconKey: "coins", profile: gameplay({ upkeep: 2, morale: 2, goods: 3, materials: -1 }) }),
  Tavern: defineBuilding({ district: "Residential District", tags: ["housing", "trade"], iconKey: "home", profile: gameplay({ gold: 8, upkeep: 4, morale: 5, populationSupport: 30 }) }),
  "Tool Shed": defineBuilding({ district: "Industrial District", tags: ["industry"], iconKey: "hammer", profile: gameplay({ upkeep: 1, prosperity: 2, materials: 2, goods: 1 }) }),
  ...
  Vendor: defineBuilding({ district: "Trade District", tags: ["trade"], iconKey: "coins", profile: gameplay({ gold: 5, upkeep: 2, prosperity: 1 }) }),
  ...
  "Woodcutter's Hut": defineBuilding({ district: "Industrial District", tags: ["industry"], iconKey: "hammer", profile: gameplay({ upkeep: 1, prosperity: 1, materials: 4 }) }),

  Alchemist: defineBuilding({ district: "Arcane District", tags: ["arcane", "industry"], iconKey: "star", profile: gameplay({ upkeep: 6, health: 5, prosperity: 3, mana: 6, goods: 2 }) }),
  ...
  Brewery: defineBuilding({ district: "Trade District", tags: ["trade"], iconKey: "coins", profile: gameplay({ gold: 16, upkeep: 5, morale: 6 }) }),
  "Carpenter Shop": defineBuilding({ district: "Industrial District", tags: ["industry"], iconKey: "hammer", profile: gameplay({ upkeep: 4, prosperity: 5, materials: -2, goods: 4 }) }),
  ...
  "Community Oven": defineBuilding({ district: "Residential District", tags: ["housing", "agriculture"], iconKey: "home", profile: gameplay({ upkeep: 2, food: 8, goods: 2, morale: 4 }) }),
  Distillery: defineBuilding({ district: "Trade District", tags: ["trade"], iconKey: "coins", profile: gameplay({ gold: 20, upkeep: 5, morale: 5 }) }),
  Dock: defineBuilding({ district: "Harbor District", tags: ["harbor", "trade"], iconKey: "anchor", profile: gameplay({ gold: 14, upkeep: 6, food: 4, populationSupport: 100, materials: 4 }) }),
  Grove: defineBuilding({ district: "Agricultural District", tags: ["agriculture", "religious"], iconKey: "leaf", profile: gameplay({ food: 6, health: 4, morale: 2 }) }),
  ...
  "Jewelry Shop": defineBuilding({ district: "Trade District", tags: ["trade", "culture"], iconKey: "coins", profile: gameplay({ gold: 18, upkeep: 5, prestige: 6 }) }),
  Library: defineBuilding({ district: "Cultural District", tags: ["culture", "civic"], iconKey: "scroll", profile: gameplay({ upkeep: 3, goods: 2, morale: 5, prosperity: 6, populationSupport: 50 }) }),
  ...
  "Mason's Workshop": defineBuilding({ district: "Industrial District", tags: ["industry"], iconKey: "hammer", profile: gameplay({ upkeep: 3, prosperity: 5, materials: 6, goods: 3 }) }),
  Pond: defineBuilding({ district: "Agricultural District", tags: ["agriculture"], iconKey: "leaf", profile: gameplay({ food: 6, health: 4 }) }),
  "Post Office": defineBuilding({ district: "Trade District", tags: ["trade", "civic"], iconKey: "banner", profile: gameplay({ gold: 10, upkeep: 3, prosperity: 5, security: 3 }) }),
  Ropeworks: defineBuilding({ district: "Industrial District", tags: ["industry"], iconKey: "hammer", profile: gameplay({ upkeep: 2, prosperity: 4, materials: 3, goods: 2 }) }),
  School: defineBuilding({ district: "Cultural District", tags: ["culture", "civic"], iconKey: "scroll", profile: gameplay({ upkeep: 4, goods: 2, morale: 5, prosperity: 7, populationSupport: 100 }) }),
  Tannery: defineBuilding({ district: "Industrial District", tags: ["industry", "trade"], iconKey: "hammer", profile: gameplay({ upkeep: 3, prosperity: 4, materials: 2, goods: 3 }) }),
  ...
  Warehouse: defineBuilding({ district: "Industrial District", tags: ["industry", "security"], iconKey: "hammer", profile: gameplay({ upkeep: 3, security: 4, prosperity: 5, materials: 8, goods: 1 }) }),
  "Weaver's Hall": defineBuilding({ district: "Industrial District", tags: ["industry", "trade"], iconKey: "hammer", profile: gameplay({ upkeep: 3, prosperity: 4, morale: 2, materials: -1, goods: 4 }) }),
  ...
  Apothecary: defineBuilding({ district: "Residential District", tags: ["housing", "arcane"], iconKey: "star", profile: gameplay({ upkeep: 6, health: 16, mana: 4, goods: 2 }) }),
  ...
  "Workshop Quarter": defineBuilding({ district: "Industrial District", tags: ["industry", "trade", "culture"], iconKey: "guild", profile: gameplay({ upkeep: 8, prosperity: 10, goods: 5, morale: 4, materials: -2 }) }),
  "Embassy Annex": defineBuilding({ district: "Trade District", tags: ["trade", "civic"], iconKey: "banner", profile: gameplay({ gold: 12, upkeep: 8, prestige: 16, prosperity: 6 }) }),
  "Engineers' Guild": defineBuilding({ district: "Industrial District", tags: ["industry", "military"], iconKey: "guild", profile: gameplay({ upkeep: 10, defense: 20, prosperity: 15, materials: 6, salvage: 3, goods: 3 }) }),
  ...
  Guildhall: defineBuilding({ district: "Trade District", tags: ["trade", "civic"], iconKey: "guild", profile: gameplay({ gold: 18, upkeep: 8, prosperity: 18 }) }),
  "Herbal Greenhouse": defineBuilding({ district: "Agricultural District", tags: ["agriculture", "arcane"], iconKey: "leaf", profile: gameplay({ upkeep: 5, health: 16, food: 10, mana: 4 }) }),
  ...
  Lighthouse: defineBuilding({ district: "Harbor District", tags: ["harbor", "security"], iconKey: "anchor", profile: gameplay({ gold: 12, upkeep: 6, security: 10, prosperity: 10 }) }),
  ...
  "Printing Press": defineBuilding({ district: "Cultural District", tags: ["culture", "industry"], iconKey: "scroll", profile: gameplay({ upkeep: 7, prosperity: 20, morale: 10, populationSupport: 100, goods: 5, materials: -1 }) }),
  ...
  "Red Light District": defineBuilding({ district: "Trade District", tags: ["trade", "housing"], iconKey: "coins", profile: gameplay({ gold: 22, upkeep: 8, morale: 12, populationSupport: 200 }) }),
  ...
  University: defineBuilding({ district: "Cultural District", tags: ["culture", "civic"], iconKey: "scroll", profile: gameplay({ upkeep: 12, prosperity: 25, morale: 12, populationSupport: 600, goods: 4 }) }),

  "Adventurers' Guildhall": defineBuilding({ district: "Frontier District", tags: ["frontier", "trade"], iconKey: "guild", profile: gameplay({ gold: 26, upkeep: 15, security: 30, prestige: 22, goods: 2 }) }),
  "Airship Dockyard": defineBuilding({ district: "Harbor District", tags: ["harbor", "military"], iconKey: "anchor", profile: gameplay({ gold: 18, upkeep: 18, security: 22, prestige: 18, materials: 6, salvage: 3, goods: 3 }) }),
  "Artifact Vault": defineBuilding({ district: "Arcane District", tags: ["arcane", "security"], iconKey: "star", profile: gameplay({ upkeep: 15, prestige: 40, security: 22, mana: 20, goods: 2 }) }),
  ...
  "Caravan Outpost": defineBuilding({ district: "Frontier District", tags: ["frontier", "trade"], iconKey: "gate", profile: gameplay({ gold: 30, upkeep: 12, food: 10, prosperity: 18, goods: 2 }) }),
  ...
  "Communications Core": defineBuilding({ district: "Arcane District", tags: ["arcane", "civic"], iconKey: "signal", profile: gameplay({ upkeep: 25, prosperity: 60, security: 30, mana: 18, salvage: 3, goods: 4 }) }),
  ...
  "Foreign Affairs Ministry": defineBuilding({ district: "Trade District", tags: ["trade", "civic"], iconKey: "banner", profile: gameplay({ gold: 28, upkeep: 15, prestige: 35, prosperity: 22 }) }),
  ...
  "Monster Arena": defineBuilding({ district: "Frontier District", tags: ["frontier", "culture"], iconKey: "gate", profile: gameplay({ gold: 32, upkeep: 18, security: 25, morale: 22, goods: 3 }) }),
  ...
  Skyharbor: defineBuilding({ district: "Harbor District", tags: ["harbor", "arcane"], iconKey: "anchor", profile: gameplay({ gold: 24, upkeep: 20, prestige: 28, populationSupport: 200, mana: 14, salvage: 4, goods: 4 }) }),
  "Steam Factory": defineBuilding({ district: "Industrial District", tags: ["industry"], iconKey: "hammer", profile: gameplay({ upkeep: 30, prosperity: 50, populationSupport: 200, materials: 14, goods: 8, salvage: 3 }) }),
  ...
  "Arcana Tower": defineBuilding({ district: "Arcane District", tags: ["arcane", "culture"], iconKey: "star", profile: gameplay({ upkeep: 30, prestige: 80, prosperity: 40, mana: 35, goods: 4 }) }),
  ...
  "Captain's Quarters": defineBuilding({ district: "Harbor District", tags: ["harbor", "housing"], iconKey: "anchor", profile: gameplay({ gold: 20, upkeep: 30, security: 60, populationSupport: 500, goods: 2 }) }),
  ...
  Dragonforge: defineBuilding({ district: "Frontier District", tags: ["frontier", "military"], iconKey: "gate", profile: gameplay({ upkeep: 35, defense: 60, security: 80, materials: 8, goods: 8, salvage: 4 }) }),
  ...
  "Elemental Shipmaker": defineBuilding({ district: "Harbor District", tags: ["harbor", "arcane"], iconKey: "anchor", profile: gameplay({ upkeep: 35, security: 70, prestige: 40, mana: 16, salvage: 6, goods: 8 }) }),
  ...
  "Raestorum Center": defineBuilding({ district: "Cultural District", tags: ["culture", "civic"], iconKey: "spire", profile: gameplay({ upkeep: 40, prosperity: 100, populationSupport: 1500, goods: 8 }) }),
  "School of Driftum": defineBuilding({ district: "Cultural District", tags: ["culture", "arcane"], iconKey: "scroll", profile: gameplay({ upkeep: 30, prosperity: 80, morale: 60, populationSupport: 500, mana: 20, goods: 6 }) }),
  ...
  Techcrafter: defineBuilding({ district: "Industrial District", tags: ["industry", "arcane"], iconKey: "hammer", profile: gameplay({ upkeep: 35, prosperity: 90, mana: 16, materials: 8, salvage: 10, goods: 10 }) }),
  ...
  "Heart of Kosmos": defineBuilding({ district: "Arcane District", tags: ["arcane", "religious"], iconKey: "star", profile: gameplay({ upkeep: 100, morale: 300, health: 300, prestige: 300, populationSupport: 1500, mana: 60, goods: 10 }) }),
  "Universal Portal": defineBuilding({ district: "Arcane District", tags: ["arcane", "harbor"], iconKey: "gate", profile: gameplay({ gold: 180, upkeep: 150, prosperity: 400, populationSupport: 500, mana: 120, salvage: 20, goods: 12 }) }),
  ...
  "New Drift Seed": defineBuilding({ district: "Frontier District", tags: ["frontier", "agriculture"], iconKey: "gate", profile: gameplay({ upkeep: 80, food: 160, prosperity: 200, populationSupport: 3000, materials: 24, goods: 8 }) }),
