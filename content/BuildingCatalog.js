...
const BUILDING_DEFINITIONS = {
  ...
  "Bank": defineBuilding({ district: "Trade District", tags: ["trade", "security"], iconKey: "coins", flavorText: "Locks, ledgers, and controlled confidence make this where wealth begins to feel institutional.", profile: gameplay({ gold: 24, upkeep: 10, prosperity: 15, security: 8, populationSupport: 20 }) }),
  ...
  "Mint": defineBuilding({ district: "Trade District", tags: ["trade"], iconKey: "coins", flavorText: "Stamped value and guarded metal make this one of the city's most concentrated expressions of trust.", profile: gameplay({ gold: 32, upkeep: 12, prosperity: 10, populationSupport: 10 }) }),
  ...
  "Immigration Center": defineBuilding({ district: "Residential District", tags: ["housing", "civic"], iconKey: "home", flavorText: "Ledgers, waiting benches, and uncertain hope make this the city's formal threshold.", profile: gameplay({ upkeep: 5, prosperity: 4, populationSupport: 260 }) }),
