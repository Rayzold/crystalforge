...
import { AdminConsole } from "./admin/AdminConsole.js?v=2.0.5";
...
import {
  ...
  updateNpcStat,
  getCrafterCapacity
} from "./systems/NpcSystem.js?v=2.0.5";
import {
  createCraftingItem,
  collectCraftingItem,
  deleteCraftingItem,
  ...
  pauseCraftingItem,
  resumeCraftingItem,
} from "./systems/CraftingSystem.js?v=2.0.5";
import { findCraftingTemplate, CRAFTING_STATIONS, craftingTemplateCategory, describeCraftingStationBonuses } from "./ui/CraftingPage.js?v=2.0.5";
import { addCooldown, removeCooldown, restartCooldown, markCooldownTriggered, ageCooldown } from "./systems/CooldownSystem.js?v=2.0.5";
import {
  addAwakened,
  clearAwakenedImage,
  removeAwakened,
...
} from "./systems/StorageSystem.js?v=2.0.5";
...
import { UIRenderer } from "./ui/UIRenderer.js?v=2.0.5";
